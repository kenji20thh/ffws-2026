...
function Header() {
    ...
    const cls = (h)=>`text-sm font-semibold tracking-wider ${path.startsWith(h) && h !== "/" || path === h ? "text-accent" : "text-white/80 hover:text-white"}`;
            ...
            open && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("nav", {
                ...
                children: [
                    ...
                    ...links
                        ...
                        className: "block border-b border-line px-4 py-3 text-sm font-semibold tracking-wider",
                        children: l ? l.toUpperCase() : "HOME"
                    }, l, false, {
                        fileName: "[project]/components/Header.tsx",
                        lineNumber: 17,
                        columnNumber: 34
...
_s(Header, "jCKIBCi3aBjWR5T1ItZoEmejbO8=", false, function() {
    return [
...
//# sourceMappingURL=components_0dwh5oi._.js.map